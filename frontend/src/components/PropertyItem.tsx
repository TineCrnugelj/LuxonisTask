...
const PropertyItem: React.FC<{property: Property}> = ({property}) => {
  ...
  return (
    <div className='w-96 shadow-lg shadow-blue-500/50 m-6 rounded-xl col-span-1'>
      <div className='relative'>
        ...
        <div className='inline-flex'>
          ...
          {currentStepIndex < NUMBER_OF_IMAGES - 1 && <CaretRightFill size={50} color='white' onClick={next} className='absolute top-2/4 right-1 cursor-pointer' />}
        </div>
