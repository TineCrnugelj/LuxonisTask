...
const PropertiesContainer = () => {
  ...
  const switchPage = (pageNumber: number) => {setPage(pageNumber)}
  const previousPage = () => {
  ...
  return (
    <div className='flex flex-col items-center'>
      <h1 className='text-blue-800 text-5xl font-bold mt-4'>Commercial properties for sale</h1>
      <PaginationButtons previousPage={previousPage} nextPage={nextPage} currentPage={page} switchPage={switchPage} />
